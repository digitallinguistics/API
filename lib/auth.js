...
exports.checkToken = (req, res) => {
  switch (req.authStatus) {
    case 'missing': r.res({ error: 'invalid_request' }, 401, res); return false;
    case 'invalid': r.res({ error: 'invalid_request' }, 401, res); return false;
    case 'expired': r.res({ error: 'invalid_request' }, 419, res); return false;
    default: return true;
  }
};
